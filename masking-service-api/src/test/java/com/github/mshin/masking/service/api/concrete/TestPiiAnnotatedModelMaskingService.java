 ...
 * @author mshin
 */
public class TestPiiAnnotatedModelMaskingService {

    private static final Logger LOGGER = LoggerFactory.getLogger(TestPiiAnnotatedModelMaskingService.class);

    @Test
    public void testMaskedContentConcrete() {

        MaskingService<PiiAnnotatedModel> service = new PiiAnnotatedModelMaskingServiceImpl();
    ...
    @Test
    public void testMaskedContentInCollectionConcrete() {
